...
<html lang="en">
	...
	<head>
		...
		<!--begin::Page Vendors Styles(used by this page)-->
		<link href="<?php echo base_url() ?>assets/assets/plugins/custom/datatables/datatables.bundle.css?v=7.2.8" rel="stylesheet" type="text/css" />
									...
									<div class="topbar-item">
										<div class="btn btn-icon btn-hover-transparent-white w-auto d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
											<div class="d-flex flex-column text-right pr-3">
												<span class="text-white opacity-50 font-weight-bold font-size-sm d-none d-md-inline">Information Retrieval System</span>
												<span class="text-white font-weight-bolder font-size-sm d-none d-md-inline">Syifa Nabila Astuti</span>
											</div>
											<span class="symbol symbol-35">
												<span class="symbol-label font-size-h5 font-weight-bold text-white bg-white-o-30">SNA</span>
											</span>
										</div>
									</div>
									<!--end::User-->
